    ...
    const handleSave = async (e) => {
        ...
        await axios("/api/Cliente/Registro", {
            ...
            .catch((error) => {
                console.log(error);
                alert(
                    "Error al intentar registrar el cliente, favor comunicarse con soporte"
                );
            });
    };
    return (
                                ...
                                <form>
                                    ...
                                    <div className="w-full p-2 text-center">
                                        <h1 className="text-xl font-bold">
                                            Proyecto del cual esta interesado
                                        </h1>
                                    </div>
                                    ...
                                    <div className="justify-between justify-items-center grid grid-cols-2 p-4">
                                        <button
                                            className="p-2 w-2/5 bg-green-600 text-white font-bold rounded-md"
                                            onClick={(e) => {
                                                handleSave(e);
                                            }}
                                        >
                                        ...
                                        <button className="p-2 w-2/5 bg-cyan-600 text-white font-bold rounded-md" onClick={(e) => {
                                            e.preventDefault()
                                            open({ visible: false })
                                        }}>
                                            Cerrar
